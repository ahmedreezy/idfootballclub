    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-16">
        <div class="mb-4 inline-flex items-center justify-center">
          <span class="relative h-14 w-14 overflow-hidden rounded-full border-2 border-gold/40 bg-black shadow-md shadow-gold/20">
            <img
              :src="isLightMode ? blackLogo : whiteLogo"
              alt="ID All Stars Football Club"
              class="absolute inset-0 h-full w-full rounded-full object-contain"
            />
          </span>
        </div>
...
const socials = [
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/idallstarsfc?igsh=dHJ3c3dhMzFzaWFt',
  ...
  {
    name: 'TikTok',
    url: 'https://www.tiktok.com/@idallstarsfc?_r=1&_t=ZS-97VNFsPjpJ6',
